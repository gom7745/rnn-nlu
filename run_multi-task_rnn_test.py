...
tf.app.flags.DEFINE_string("intent", None, "Training directory.")
    ...
    with tf.Session() as sess:
        ...
        # Run evals on development/test set and print the accuracy.
            ...
            if task['intent'] == 1:
                ...
                if FLAGS.intent is not None:
                    df = pd.DataFrame(hyp_label_list)
                    df.to_csv(FLAGS.intent, index=False, header=None)
